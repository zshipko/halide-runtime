...
extern "C" {
    pub fn halide_opencl_device_interface() -> *const halide_device_interface_t;
}
extern "C" {
    pub fn halide_opencl_initialize_kernels(
        user_context: *mut ::std::os::raw::c_void,
        state_ptr: *mut *mut ::std::os::raw::c_void,
        src: *const ::std::os::raw::c_char,
        size: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn halide_opencl_run(
        user_context: *mut ::std::os::raw::c_void,
        state_ptr: *mut ::std::os::raw::c_void,
        entry_name: *const ::std::os::raw::c_char,
        blocksX: ::std::os::raw::c_int,
        blocksY: ::std::os::raw::c_int,
        blocksZ: ::std::os::raw::c_int,
        threadsX: ::std::os::raw::c_int,
        threadsY: ::std::os::raw::c_int,
        threadsZ: ::std::os::raw::c_int,
        shared_mem_bytes: ::std::os::raw::c_int,
        arg_sizes: *mut usize,
        args: *mut *mut ::std::os::raw::c_void,
        arg_is_buffer: *mut i8,
        num_attributes: ::std::os::raw::c_int,
        vertex_buffer: *mut f32,
        num_coords_dim0: ::std::os::raw::c_int,
        num_coords_dim1: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn halide_opencl_set_platform_name(n: *const ::std::os::raw::c_char);
}
extern "C" {
    pub fn halide_opencl_get_platform_name(
        user_context: *mut ::std::os::raw::c_void,
    ) -> *const ::std::os::raw::c_char;
}
extern "C" {
    pub fn halide_opencl_set_device_type(n: *const ::std::os::raw::c_char);
}
extern "C" {
    pub fn halide_opencl_get_device_type(
        user_context: *mut ::std::os::raw::c_void,
    ) -> *const ::std::os::raw::c_char;
}
extern "C" {
    pub fn halide_opencl_wrap_cl_mem(
        user_context: *mut ::std::os::raw::c_void,
        buf: *mut halide_buffer_t,
        device_ptr: u64,
    ) -> ::std::os::raw::c_int;
...
extern "C" {
    pub fn halide_opencl_detach_cl_mem(
        user_context: *mut ::std::os::raw::c_void,
        buf: *mut halide_buffer_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn halide_opencl_get_cl_mem(
        user_context: *mut ::std::os::raw::c_void,
        buf: *mut halide_buffer_t,
    ) -> usize;
}
extern "C" {
    pub fn halide_opencl_get_crop_offset(
        user_context: *mut ::std::os::raw::c_void,
        buf: *mut halide_buffer_t,
    ) -> u64;
}
